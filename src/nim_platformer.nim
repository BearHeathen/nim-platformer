...
proc renderPlayer(renderer: RendererPtr, texture: TexturePtr, pos: Point2d) =
  ...
  # and compose them into a whole.
  # TODO: make feet move in rotating motion according to player x pos.
  # TODO: Make eyes follow mouse cursor.
...
proc restartPlayer(player: Player) =
    player.pos = point2d(170.0, 500.0)
    player.vel = vector2d(0.0, 0.0)
